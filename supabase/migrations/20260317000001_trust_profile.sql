...
CREATE POLICY IF NOT EXISTS "business_documents_insert_own"
...
CREATE POLICY IF NOT EXISTS "business_documents_delete_own"
...
CREATE POLICY IF NOT EXISTS "business_documents_select_connected"
